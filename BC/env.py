# This is an exact copy of gridworld env
import gym
...
def collision_with_gem(score):
    gem_position = [random.randrange(1, 10) * 50, random.randrange(1, 10) * 50]
    return gem_position, score+1, 10000
...
class singleEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if self.player == self.gem_position:
            self.gem_position, self.score, gem_reward = collision_with_gem(self.score)
            self.total_gems += 1
            self.num_steps = 0
        else:
        ...
        self.total_reward = (150 + gem_reward - euclidean_dist)
    ...
    def reset(self):
        ...
        self.num_steps = 0
        # Mine Wall
        self.wall_position = [[250, y] for y in range(0, 500, 50)]
        # Initial Player and Gem position
        self.player_position = [[0, 250]]
        self.gem_position = [random.randrange(1, 10) * 50, random.randrange(1, 10) * 50]
        self.score = 0
