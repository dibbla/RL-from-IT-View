...
class SymbolicObsWrapperFlattenDirect(ObservationWrapper):
    """
    Fully observable grid with a symbolic state representation.
    The symbol is a triple of (X, Y, IDX), where X and Y are
    the coordinates on the grid, and IDX is the id of the object.

    Return: full observation flattened into single vector, last additional entry is direction
    """
    ...
    def observation(self, obs):
        ...
        return np.concatenate([grid_id.flatten(),np.array([obs['direction']])])

class SymbolicObsWrapperFullFlattenDirect(ObservationWrapper):
    """
    Fully observable grid with a symbolic state representation.
    The symbol is a triple of (X, Y, IDX), where X and Y are
    the coordinates on the grid, and IDX is the id of the object.

    Simple flattened orginal SymbolicObs, addtional direction entry
    """
    ...
    def observation(self, obs):
        ...
        return np.concatenate([grid.flatten(),np.array([obs['direction']])])